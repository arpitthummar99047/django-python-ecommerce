...
//if(currentUrl.indexOf('beta-')>-1 ||currentUrl.indexOf('localhost')>-1){
//s_account='flipsellerdev';
//}else{
//s_account='flipkartsellerprod';
//}
...
//To curb the default page load call.
s.abort=true;
...
function s_doPlugins(s)
{
	...
	s.prop10 = s.eVar10= s.getTimeParting('s','+5.5');
	
	/* Visitor Status Tracking */
	s.eVar9=s.getNewRepeat(365);
	
		//Average Page Load Time
		// Working version from Wiki below this code
		/*var pageLoadTime=s_getLoadTime()/10;
	    if(pageLoadTime >0 && pageLoadTime <= 90){
	     s.eVar8=s.prop8=pageLoadTime;
	    s.events=s.apl(s.events,'event1='+pageLoadTime,',',1);
	    }
	    else if(pageLoadTime > 90){
	      s.eVar8=s.prop8=90;
	      s.events=s.apl(s.events,'event1='+90,',',1);
	    }else{
		s.eVar8=s.prop8='0';
		s.events=s.apl(s.events,'event1='+0,',',1);
		}*/
  
		//s.eVar8 = s.getLoadTime("browserapi","event1","event41");
