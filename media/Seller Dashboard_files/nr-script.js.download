...
NREUM.loader_config = {
  accountID: document.currentScript.getAttribute("data-account-id"),
  trustKey: "3293794",
  agentID: document.currentScript.getAttribute("data-agent-id"),
  licenseKey: document.currentScript.getAttribute("data-license-key"),
  applicationID: document.currentScript.getAttribute("data-application-id"),
};
NREUM.info = {
